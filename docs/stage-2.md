...
顾客按低峰或高峰节奏到店，每张空桌只分配一位顾客。顶部四张订单卡展示状态、菜品与剩余耐心；不足 12 秒会变红。按 Q 切换待做订单，靠近烹饪台按 E 进入对应菜品的小游戏。后续协作版本增至两个烹饪台和两个出餐位置；做好的菜需取走并送到正确餐桌。顾客用餐、付款、评价后离店；玩家收盘并回收餐盘，桌位重新可用。每完成两桌出现一处污渍；空手靠近污渍按 E 清洁。污渍上限三处。
